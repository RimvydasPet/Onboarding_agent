...
Purpose: Establish a minimum security standard for laptops and desktops to reduce risk from malware, phishing, and data loss.

Scope: All company-managed endpoints, including loaner devices and developer workstations.
